...
export interface StarfieldBackgroundProps {
    ...
    /** Enable twinkling */
    twinkle?: boolean
    /** Canvas background color in light mode (hex) */
    bgColor?: string
    /** Canvas background color in dark mode (hex), used when <html> has class="dark" */
    bgColorDark?: string
}
...
export function StarfieldBackground({
    ...
    // Track the `dark` class on <html>, same mechanism Tailwind's dark: variant relies on.
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const maxDepth = 1500
        const { r, g, b } = hexToRgb(isDark ? bgColorDark : bgColor)
    ...
    }, [ count, speed, starColor, twinkle, isDark, bgColor, bgColorDark ])
