        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto w-full px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-10 md:gap-12">
                ...
                <div className="order-1 md:order-2 flex justify-center md:justify-end">
                    <div className="w-36 h-36 sm:w-44 sm:h-44 md:w-95 md:h-95 rounded-full bg-black overflow-hidden shadow-2xl shadow-black">
                        <img
                            src={photo1}
                            alt="Abdallah Nabil"
                ...
                <div className="order-2 md:order-1 text-center md:text-left">
                    ...
                    <div className="flex justify-center md:justify-start text-xl sm:text-2xl md:text-3xl text-indigo-400 mb-8 md:mb-10">
                        <h2>
                            {"> "}
                            <TypeAnimation
                                sequence={[
                    ...
                    <div className="inline-block text-left mx-auto md:mx-0 space-y-1 text-slate-400 text-sm md:text-base">
                        <p>
                        ...
                        <p>
                            <span className="text-indigo-400">const</span>{" "}
                            <span className="text-emerald-400">Facebook</span>{" "}
                            <span className="text-slate-300">=</span>{" "}
                            <span className="text-orange-300">
                                "abdallah.nabil.9421"
                            </span>
